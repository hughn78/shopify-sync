...
class SourceProduct(Base):
    ...
    external_variant_id: Mapped[Optional[str]] = mapped_column(String(255), index=True)
    external_inventory_item_id: Mapped[Optional[str]] = mapped_column(String(255), index=True)
    external_location_id: Mapped[Optional[str]] = mapped_column(String(255), index=True)
    source_location_name: Mapped[Optional[str]] = mapped_column(String(255))
...
class InventoryReconciliationRow(Base):
    ...
    shopify_variant_id: Mapped[Optional[str]] = mapped_column(String(255))
    shopify_inventory_item_id: Mapped[Optional[str]] = mapped_column(String(255))
    shopify_location_id: Mapped[Optional[str]] = mapped_column(String(255))
    shopify_location_name: Mapped[Optional[str]] = mapped_column(String(255))
